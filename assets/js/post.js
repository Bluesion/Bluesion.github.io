(window.webpackJsonp = window.webpackJsonp || []).push([
	[6], {
		...
		21: function (t, e, n) {
			...
			function b() {
				f = window.pageYOffset, k()
			}

			function g(t) {
				Object(l.isMobile)("1023px") ? (o()("body").addClass("share-menu-displayed"), setTimeout(function () {
			...
			function v() {
				j(), g(100), setTimeout(function () {
					x(), k()
				}, 200)
			}

			function k() {
				p || requestAnimationFrame(y), p = !0
			}
			...
			function y() {
				...
				e <= 100 && function (t) {
					if (t <= 100) {
						var e = w - t / 100 * w;
						d[0].style.strokeDashoffset = e
					}
				}(e), p = !1
			}

			function j() {
				m = window.innerHeight, h = o()(document).height()
			}

			function x() {
				var t = d.parent().width() / 2,
					e = Object(l.isMobile)() ? 2 : 3;
				d.attr("stroke-width", e), d.attr("r", t - (e - 1)), d.attr("cx", t), d.attr("cy", t), w = 2 * t * Math.PI, d[0].style.strokeDasharray = "".concat(w, " ").concat(w), d[0].style.strokeDashoffset = w
			}

			function M() {
				d = o()(".js-progress"), j(), x(), y(), setTimeout(function () {
			...
			o()(document).ready(function () {
				...
				c()(".js-post-content"),
					...
					}(), g(1e3), i.length > 0 && (i.on("init", function () {
						M()
					}), i.slick({
						arrows: !0,
						infinite: !0,
					...
					}), Object(s.a)(".js-zoomable"), window.addEventListener("scroll", b, {
						passive: !0
