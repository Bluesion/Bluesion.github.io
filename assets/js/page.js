	...
	[5], {
		...
		23: function (t, e, a) {
			...
			n()(document).ready(function () {
				r()(".js-post-content"),
					function () {
						for (var t = document.querySelectorAll(".kg-gallery-image img"), e = 0, a = t.length; e < a; e++) {
							var s = t[e].closest(".kg-gallery-image"),
								n = t[e].attributes.width.value / t[e].attributes.height.value;
							s.style.flex = "".concat(n, " 1 0%")
						}
					}(), n()(".js-post-content").find("figure img").each(function () {
						n()(this).closest("figure").hasClass("kg-bookmark-card") || n()(this).addClass("js-zoomable");
